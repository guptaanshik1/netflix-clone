    ...
    <div className="relative h-[100%]">
      ...
      >
        <img
          ...
          alt=""
        />
        <button className="fixed top-5 right-5 p-[10px] text-sm text-[#FFFFFF] bg-[#e50914] cursor-pointer font-semibold">
          Sign in
        </button>
      ...
      <div className="z-10 text-white p-5 absolute top-[30%] mx-auto text-center">
        <>
          ...
          <div className="m-5">
            <form>
              <input
                ...
                type="email"
              />
              <button className="px-4 py-5 text-base bg-[#e50914] border-none color-[#ffffff] font-semibold cursor-pointer">
                GET STARTED
              </button>
            </form>
          </div>
